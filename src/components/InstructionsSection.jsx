...
const InstructionsSection = () => {
  return (
    <section className="flex-row font-productSans md:flex lg:flex justify-center">
      <div className=" w-full lg:w-1/2 bg-[#ffffff]">
        <div className="relative mx-18 my-18 lg:mx-40 lg:my-32">
          <div>
            <img className="h-40 lg:h-90" src="/bread-pattern.png" alt="" />
          </div>
          <div className="absolute -top-6 lg:-top-10 -left-4">
            <img className="h-40 lg:h-90" src="/bakery_img 2.png" alt="" />
          </div>
        </div>
      </div>
      <div className="w-full lg:w-1/2 mx-20 ">
        <h2 className="text-[#2b2b2b] font-bold text-md md:text-4xl lg:text-5xl">
          Getting started with
        </h2>
        <h2 className="text-[#2b2b2b] font-bold md:text-4xl lg:text-5xl">
